 ...
 .sign.error-page-wrapper .buttons-container a:hover .fa-home {
  ...
  @media screen and (max-width: 500px) {
   ...
   .sign.error-page-wrapper .buttons-container .fa {
    ...
    .background-color {
      background-color: rgba(22, 201, 117, 1) !important;
    }
    ...
    .secondary-text-color {
      color: rgba(249, 87, 255, 1) !important;
    }
  ...
  <body class="sign error-page-wrapper background-color background-image">
    <div id="fh5co-page" style="float: left;">
...
<div class="text-container">
	...
	<div class="context primary-text-color">
      ...
      URLが変更されているため見つけることができません。
		</p>
	</div>
	<!-- <div class="buttons-container"> -->
		<!-- <a class="border-button" href=" http://with-sabae.com" target="_blank"><span class="fa fa-home"></span> Home Page</a> -->
		<!-- <a class="border-button" href="mailto: " target="_blank"><span class="fa fa-warning"></span> Report Problem</a> -->
	<!-- </div> -->
</div>
