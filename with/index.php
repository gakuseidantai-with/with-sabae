...
{
	die('No composer autoloader found. Please run composer to install the FuelPHP framework dependencies first! path: '.DOCROOT.'classes'.DIRECTORY_SEPARATOR.'autoloader.php');
}
